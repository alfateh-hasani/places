<section class="search container px-40 -translate-y-[50%]">
    <form action="{{ route('apartments.search') }}" method="GET"
      class="grid grid-cols-5 gap-1 max-w-full py-5 pl-10 pr-5 bg-white shadow-xl rounded-full"   id="date-range-picker" date-rangepicker >
      <div>
      ...
      <div>
        ...
        >
          <img
            class="inline-block -translate-y-0.5 mr-2 rtl:ml-2"
