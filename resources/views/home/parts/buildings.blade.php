<section class="properitirs pt-10 pb-10 md:pt-20 md:pb-20 mb-10 bg-properits">
    <div class="container">
        <p class="font-normal text-xs md:text-base text-price text-center md:text-left rtl:md:text-right">
            @lang('site.explore_buildings')
        </p>
