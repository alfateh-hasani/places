...
<section class="search lg:container z-40 xl:px-40 lg:py-16 h-[100vh] lg:h-auto fixed lg:relative left-0 bottom-0 right-0 bg-blackopacity lg:bg-[transparent]" data-aos="zoom-out">
  ...
  <section class="filter">
    <form>
        <div class="container">
            <div class="float-left rounded-xl bg-filterbackground border border-filterborder px-5 py-1.5 buttons mb-2 xl:mb-0" data-aos="fade-right">
                <p class="float-left mr-2 font-semibold text-base text-black pt-1.5 mb-1 lg:mb-0">Filter By</p>
                <div class="float-left mr-2 mb-1 lg:mb-0">
                    ...
                    <div id="dropdownSearch1" class="z-10 hidden bg-white rounded-lg shadow w-60">
                        <ul class="h-48 px-3 py-3 overflow-y-auto text-sm text-gray-700" aria-labelledby="dropdownSearchButton">
                            <li>
                                <div class="flex items-center p-2 rounded hover:bg-gray-100">
                                    <input id="checkbox-item-1" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded">
                                    <label for="checkbox-item-1" class="w-full ms-2 text-sm font-medium text-gray-900 rounded">min <img class="inline-block -translate-y-0.5" src="assets/img/star.svg" /></label>
                                </div>
                            </li>
                            <li>
                                <div class="flex items-center p-2 rounded hover:bg-gray-100">
                                    <input id="checkbox-item-2" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded">
                                    <label for="checkbox-item-2" class="w-full ms-2 text-sm font-medium text-gray-900 rounded">min <img class="inline-block -translate-y-0.5" src="assets/img/star.svg" /><img class="inline-block -translate-y-0.5" src="assets/img/star.svg" /></label>
                                </div>
                            </li>
                            <li>
                                <div class="flex items-center p-2 rounded hover:bg-gray-100">
                                    <input id="checkbox-item-3" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded">
                                    <label for="checkbox-item-3" class="w-full ms-2 text-sm font-medium text-gray-900 rounded">min <img class="inline-block -translate-y-0.5" src="assets/img/star.svg" /><img class="inline-block -translate-y-0.5" src="assets/img/star.svg" /><img class="inline-block -translate-y-0.5" src="assets/img/star.svg" /></label>
                                </div>
                            </li>
                            <li>
                                <div class="flex items-center p-2 rounded hover:bg-gray-100">
                                    <input id="checkbox-item-4" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded">
                                    <label for="checkbox-item-4" class="w-full ms-2 text-sm font-medium text-gray-900 rounded">min <img class="inline-block -translate-y-0.5" src="assets/img/star.svg" /><img class="inline-block -translate-y-0.5" src="assets/img/star.svg" /><img class="inline-block -translate-y-0.5" src="assets/img/star.svg" /><img class="inline-block -translate-y-0.5" src="assets/img/star.svg" /></label>
                                </div>
                            </li>
                            <li>
                                <div class="flex items-center p-2 rounded hover:bg-gray-100">
                                    <input id="checkbox-item-5" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded">
                                    <label for="checkbox-item-5" class="w-full ms-2 text-sm font-medium text-gray-900 rounded">min <img class="inline-block -translate-y-0.5" src="assets/img/star.svg" /><img class="inline-block -translate-y-0.5" src="assets/img/star.svg" /><img class="inline-block -translate-y-0.5" src="assets/img/star.svg" /><img class="inline-block -translate-y-0.5" src="assets/img/star.svg" /><img class="inline-block -translate-y-0.5" src="assets/img/star.svg" /></label>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="float-right border-0 lg:border-l border-commentborder pl-0 lg:pl-5 my-1.5 w-full lg:w-auto">
                    <button class="float-left w-6 h-6 rounded-md mr-2 text-center bg-sort">
                    ...
                    <button class="float-left w-6 h-6 rounded-md text-center rotate-180 bg-sortactive">
                        <svg class="w-2.5 h-2.5 inline-block" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
