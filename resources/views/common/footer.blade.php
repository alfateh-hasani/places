    ...
    <div class="lg:grid lg:grid-cols-3 lg:gap-8 max-w-full">
      ...
      <div class="my-6 lg:my-0">
        ...
        <ul class="mt-4 lg:mt-10 grid grid-cols-2 gap-2 max-w-full mx-0">
          <li><a class="block font-light text-black mb-2 lg:mb-5" href="{{route('home')}}">{{__('site.home')}}</a li>
          <li><a class="block font-light text-black mb-2 lg:mb-5" href="{{route('page','privacy-policy')}}"> {{__('site.privacy-policy')}}</a></li>
          <li><a class="block font-light text-black mb-2 lg:mb-5" href="{{route('page','terms-and-conditions')}}"> {{__('site.terms')}}  </a></li>
          <li><a class="block font-light text-black mb-2 lg:mb-5" href="{{route('page','contact')}}">{{__('site.blogs')}}</a></li>
          <li><a class="block font-light text-black mb-2 lg:mb-5" href="{{route('page','contact')}}">
            {{__('site.contact')}}  
          </a></li>
          <li><a class="block font-light text-black mb-2 lg:mb-5" href="{{route('page','contact')}}">
            {{__('site.contact_us_menu')}}  
          </a></li>
          <li><a class="block font-light text-black mb-2 lg:mb-5" href="{{route('page','faq')}}">    {{__('site.faqs')}}  </a></li>
        </ul>
      </div>
      <div>
        <h6 class="font-semibold text-xl text-black">
